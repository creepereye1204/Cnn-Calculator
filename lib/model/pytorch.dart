...
class Pytorch extends StatefulWidget {
  const Pytorch({Key? key}) : super(key: key);

  @override
  State<Pytorch> createState() => _PytorchState();
}

class _PytorchState extends State<Pytorch> {
                              ...
                              onPressed: ()
                              {
                                ...
                                for(int i=0;i<Code.length;i++){
                                  ...
                                  switch(Code[i][0].toString()) {
                                    case "Cond2d":
                                      Pytorch_Code+='self.conv'+(i+1).toString()+'= nn.Conv2d('+(i!=0?Code[i-1][1]:In_channel.toString())+','+Code[i][1]+','+Code[i][2]+','+Code[i][3]+','+Code[i][4]+')'+'\n';
                                      break;
                                    case "Pooling":
                                      Pytorch_Code+='self.pool'+(i+1).toString()+'= nn.MaxPool2d('+(i!=0?Code[i-1][1]:In_channel.toString())+','+Code[i][1]+','+Code[i][2]+','+Code[i][3]+','+Code[i][4]+')'+'\n';
                                      break;
                                    case "Trans2d":
                                      Pytorch_Code+='self.Trans2d'+(i+1).toString()+'= nn.ConvTranspose2d('+(i!=0?Code[i-1][1]:In_channel.toString())+','+Code[i][1]+','+Code[i][2]+','+Code[i][3]+','+Code[i][4]+')'+'\n';
                                      break;
                                    default:
                                      break;
                                  }
                                ...
                                SideSheet.right(
                                  body: Scaffold(appBar: AppBar(title: Text('Pytorch')),body: Text(Pytorch_Code,style: TextStyle(
                                      fontSize: 25,
                                      color: Colors.orange,
                                      fontWeight: FontWeight.bold
                                  ),),),
